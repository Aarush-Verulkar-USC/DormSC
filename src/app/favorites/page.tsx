      ...
      <div className="min-h-screen bg-gray-50">
        <div className=" pt-24 pb-12 flex items-center justify-center min-h-screen">
          <div className="max-w-md mx-auto px-4 text-center">
            <div className="bg-white border border-gray-300 rounded-3xl p-8 shadow-lg">
              ...
              <Link
                href="/login"
                className="inline-flex items-center gap-2 w-full py-3 px-6 bg-brand text-white rounded-2xl font-medium hover:bg-brand/90 transition-all duration-300 hover:-translate-y-0.5 shadow-lg justify-center"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[...Array(6)].map((_, i) => (
                <div key={i} className="group">
                  <div className="bg-gray-100 border border-gray-200 rounded-3xl overflow-hidden hover:bg-gray-200 transition-all duration-500">
                    <div className="aspect-[4/3] bg-gradient-to-br from-gray-200/50 to-gray-100/50 animate-pulse" />
                    <div className="p-6 space-y-4">
                      <div className="h-6 bg-gray-300 rounded-xl animate-pulse" />
                      <div className="h-4 w-2/3 bg-gray-300 rounded-lg animate-pulse" />
                      <div className="flex justify-between items-center pt-2">
                        <div className="h-5 w-20 bg-gray-300 rounded-lg animate-pulse" />
      ...
      <div className=" pt-24 pb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            {count > 0 && (
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-red-50 border border-red-200 rounded-full text-red-600 text-sm">
