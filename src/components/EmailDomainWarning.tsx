...
export default function EmailDomainWarning() {
    ...
    return (
        <div className="fixed top-20 right-4 z-[100] animate-slide-in-right">
            <div className="bg-white rounded-2xl p-4 shadow-[0_4px_30px_rgba(0,0,0,0.12)] max-w-sm">
                <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                        <h3 className="text-sm font-semibold text-gray-900 mb-0.5">Unauthorized Email</h3>
